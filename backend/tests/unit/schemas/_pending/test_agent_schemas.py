...
class TestAgentCreate:
    ...
    def test_valid_agent_create(self):
        ...
        assert agent.llm_config.model == "claude-3-5-sonnet-20241022"
...
class TestAgentUpdate:
    ...
    def test_valid_agent_update_all_fields(self):
        ...
        assert update.llm_config.provider == "openai"
...
class TestAgentResponse:
    ...
    def test_valid_agent_response(self):
        ...
        assert response.llm_config.provider == "anthropic"
        assert response.llm_config.model == "claude-3-5-sonnet-20241022"
...
class TestAgentSchemasIntegration:
    ...
    def test_agent_create_to_response_flow(self):
        ...
        assert response.llm_config.provider == create.llm_config.provider
